...
- :telescope: I’m working as a Data Engineer/python developer working on data orchestration, developing data visualization applications

- :seedling: Exploring what all can be acheived with python and around big data.
